...
tools/
  ...
  make_avatar.py           Regenerates both avatar sprites (24x24, indexed PNGs, shared palette)
...
See [TODO.md](TODO.md) for what's next (Room 3 onward, combat, real D&D stats, real art).
